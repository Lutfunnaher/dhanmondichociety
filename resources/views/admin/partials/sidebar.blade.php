@php use App\Models\MembershipCategory; @endphp
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Member Type</div>
            </a>
            ...
            <ul class="menu-sub">
                {{-- executive --}}
                <li class="menu-item">
                    <a href="{{ route('member.executive') }}" class="menu-link">
                        <div data-i18n="Without menu">Executive Member</div>
                    </a>
                </li>
